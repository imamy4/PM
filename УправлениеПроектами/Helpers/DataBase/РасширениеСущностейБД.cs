...
namespace УправлениеПроектами
{
    public static class РасширениеСущностейБД
    {
        ...
        public static decimal СуммарнаяОценкаРаботПоОткрытымТребованиям(this Спринт спринт)
        {
        ...
        public static decimal ЗатраченоВремени(this Требование требование)
        {
            return требование.Активности.Sum(активность => активность.ЗатраченноеВремя);
        }
        ...
        {
            return проект.Требования.Sum(x => x.Оценка);
        }

        public static decimal СуммарнаяОценкаРаботПоОткрытымТребованиям(this Проект проект)
        {
            return проект.Требования.ОткрытыеТребования().Sum(x => x.Оценка);
        }


        public static decimal ЗатраченоВремени(this Проект проект)
        {
            return проект.Требования.Sum(требование => требование.Активности.Sum(активность => активность.ЗатраченноеВремя));
        }
